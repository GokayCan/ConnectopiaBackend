...
using Connectopia.Application.Dtos.User;
...
namespace Connectopia.Persistence.Services
{
    public class UserService : IUserService
    {
        ...
        {
            int userId;
            bool isInteger = int.TryParse(userIdOrName, out userId);

            var user = isInteger ? await _userManager.FindByIdAsync(userIdOrName) : await _userManager.FindByNameAsync(userIdOrName);
